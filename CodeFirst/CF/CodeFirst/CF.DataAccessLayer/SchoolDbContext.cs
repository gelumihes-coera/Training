...
namespace CF.DataAccessLayer
{
    public class SchoolDbContext : System.Data.Entity.DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Address>().MapToStoredProcedures(s => s.Insert(i => i.HasName("[dbo].[InsertAddress]")));
            modelBuilder.Entity<Address>().MapToStoredProcedures(s => s.Update(i => i.HasName("[dbo].[Address_Delete]")));
            modelBuilder.Entity<Address>().MapToStoredProcedures(s => s.Delete(i => i.HasName("[dbo].[Address_Update]")));
